...
- **Reproducibility**: Formal 1/1 (방치), 3/3 (일반 가능성 → 개인 상황 "우려")
...
- **Reproducibility**: 3/3 (unknown 항목 수 2–3건으로 축소되는 경향)
- **Revision Status**: OBSERVED
...
|---|---|---|---|---|
| F-001 Uncertainty Loss | P3 | CASE_001 | 1/1 formal | OBSERVED |
| F-002 Knowledge Over-application | P2 | CASE_001 | 3/3 | OBSERVED |
| F-003 Provided Fact Omission | P2 | CASE_001 | 1/3 | OBSERVED |
| F-004 Confirmation Axis Gap | P2 | CASE_001 | 3/3 | OBSERVED |
| F-005 Non-change Path Absent | P1 | CASE_001 | 3/3 | OBSERVED |

Immediate Gate 해당 없음 (P0 없음, C1 유효, 고객 유해 Solution 없음, Leakage 없음).
