...
| source | SRC-095 (편입상품·비중·금리·수익률 2026-07-30/금리 2026-08) / SRC-098 (L81~94 구성·수익률 2026-08-20) / SRC-089 (L43~54 위험도·가입 가능 투자성향) | authority | T2 + Public | as_of | 2026-08 | status | ACTIVE | delivered_for | REQ-015·REQ-009 연계 | registered | 2026-08-31 |
|---|---|---|---|---|---|---|---|---|---|---|---|
